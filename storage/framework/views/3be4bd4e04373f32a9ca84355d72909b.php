                ...
                <form id="sub-payment-form">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group"  style="display: flex; align-items: center; gap: 10px;">
                            <div class="input-group-svg">
                                <img src="<?php echo e(asset('images/icons/ru.svg')); ?>" width="55" height="55" alt="SUP Icon" class="icon">
                            </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group" style="display: flex; align-items: center; gap: 10px;">
                            ...
                            <div class="input-group-svg">
                                <img src="<?php echo e(asset('images/icons/house.svg')); ?>" width="55" height="55" alt="SUP Icon" class="icon">
                            </div>
                        </div>

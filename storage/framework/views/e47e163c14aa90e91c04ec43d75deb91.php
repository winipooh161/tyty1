            ...
            <div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="<?php echo e(route('admin.template-categories.index')); ?>" class="btn btn-primary">Управление категориями</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="<?php echo e(route('admin.templates.index')); ?>" class="btn btn-primary">Управление шаблонами</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-primary">Управление пользователями</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="<?php echo e(route('client.templates.categories')); ?>" class="btn btn-outline-primary">Просмотр категорий</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="<?php echo e(route('user.templates')); ?>" class="btn btn-outline-primary">Мои шаблоны</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="<?php echo e(route('client.dashboard')); ?>" class="btn btn-outline-primary">Перейти в кабинет клиента</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\tyty\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (qrCodeContainer) {
            ...
            setTimeout(function() {
                try {
                    ...
                    const templateId = <?php echo e($userTemplate->id); ?>;
                    ...
                    <?php if($acquiredTemplate): ?>
                    const acquiredId = <?php echo e($acquiredTemplate->id); ?>;
                    <?php else: ?>
                    const acquiredId = 0;
                    <?php endif; ?>
                    ...
                    const changeStatusUrl = `${baseUrl}/template-status/change/${templateId}/${userId}/${acquiredId}/${timestamp}?_token=${csrfToken}&nonce=<?php echo e(Str::random(10)); ?>`;
        ...
        const seriesData = <?php echo json_encode($seriesData ?? null, 15, 512) ?> || {
            'acquired_count': 0, 
            'scan_count': 0, 
            'series_quantity': 1, 
            'required_scans': 1

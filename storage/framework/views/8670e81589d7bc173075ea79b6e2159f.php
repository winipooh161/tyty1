<div id="coverPreviewContainer" class="cover-container mb-3">
    ...
    <?php if(session('media_editor_file')): ?>
        ...
        <?php if($isVideo && $coverExists): ?>
            <video id="coverVideo" class="cover-video" autoplay loop muted playsinline>
                <source src="<?php echo e($coverPath); ?>" type="video/mp4">
                Ваш браузер не поддерживает видео.
            </video>
        <?php elseif(!$isVideo && $coverExists): ?>
            <img src="<?php echo e($coverPath); ?>" class="cover-image" alt="Обложка шаблона">
        <?php endif; ?>

    
    <?php elseif(isset($userTemplate) && $userTemplate && $userTemplate->cover_path): ?>
        <?php
        ...
        <?php if($isVideo && $coverExists): ?>
            <video id="coverVideo" class="cover-video" autoplay loop muted playsinline>
                <source src="<?php echo e(asset($coverPath)); ?>" type="video/mp4">
                Ваш браузер не поддерживает видео.
            </video>
        <?php elseif(!$isVideo && $coverExists): ?>
...
<?php /**PATH C:\OSPanel\domains\tyty\resources\views/templates/components/editor-cover.blade.php ENDPATH**/ ?>
...
<link href="https://fonts.googleapis.com/css2?family=Comfortaa:wght@300..700&display=swap" rel="stylesheet">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(function() {
                ...
                workerScript.src = '<?php echo e(asset("js/qr-scanner-worker.min.js")); ?>';
                workerScript.async = true;
                document.head.appendChild(workerScript);
                
                // Затем загружаем основной скрипт
                const script = document.createElement('script');
                script.src = '<?php echo e(asset("js/qr-scanner.min.js")); ?>';
                script.async = true;
                script.onload = function() {
                    if (window.QrScanner) {
                        QrScanner.WORKER_PATH = '<?php echo e(asset("js/qr-scanner-worker.min.js")); ?>';
    ...
    <!-- Vite Assets -->
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/css/mobile-nav.css', 'resources/css/mobile-nav-hint.css', 'resources/css/modal-styles.css', 'resources/js/app.js']); ?>

    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mb-4 d-flex align-items-center">
                <h2>Редактирование категории: <?php echo e($category->name); ?></h2>
            </div>
            
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.template-categories.update', $category->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                <img src="<?php echo e(asset('storage/category_images/'.$category->image)); ?>" alt="<?php echo e($category->name); ?>" class="img-thumbnail" style="max-height: 150px;">
...
unset($__errorArgs, $__bag); ?>" id="display_order" name="display_order" value="<?php echo e(old('display_order', $category->display_order)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="<?php echo e(route('admin.template-categories.index')); ?>" class="btn btn-secondary">Отмена</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\tyty\resources\views/admin/template-categories/edit.blade.php ENDPATH**/ ?>
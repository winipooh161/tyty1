...
<head>
    ...
    <!-- Vite Assets -->
    @vite(['resources/css/app.css', 'resources/css/style.css', 'resources/css/mobile-nav.css', 'resources/css/mobile-nav-hint.css', 'resources/css/modal-styles.css', 'resources/js/app.js'])

    <!-- Дополнительные стили и скрипты -->
    @yield('styles')
    <link href="{{ asset('css/template-editor.css') }}" rel="stylesheet">
...
<body class="mobile-only-mode">
    ...
    <div id="app" class="d-flex">
        ...
        <main
            class="py-4 flex-grow-1 content-wrapper {{ request()->routeIs('client.templates.editor') ? 'p-0' : '' }}">
            @yield('content')
        </main>
    </div>

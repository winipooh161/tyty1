            ...
            <div class="modal-panel-content">
                ...
                <div class="modal-panel-body">
                    <div class="text-center mb-4">
                        <div class="avatar-upload-container position-relative mx-auto blur-gradient-effect" style="width: 150px; height: 150px;">
                        ...
                        @endphp
                        <p class="badge bg-primary">Баланс SUP: {{ $supBalance }}</p>
                    </div>
                    
                    <!-- Форма обновления профиля -->
                    <form id="profile-update-form" action="{{ route('user.update-profile') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
/* Эффект размытия для аватара в модальном окне профиля */
...
#user-profile-modal .modal-panel-content {
    padding: 20px;
    border-radius: 16px;
    box-shadow: 0 4px 16px rgba(0, 0, 0, 0.2);
}

#user-profile-modal .modal-panel-header {
    border-bottom: 2px solid #007bff;
}

#user-profile-modal .modal-panel-title {
    color: #007bff;
}
...
#user-profile-modal .btn-primary:hover {
    background-color: #218838;
    border-color: #1e7e34;
}

#user-profile-modal .btn-secondary {
    background-color: #ffc107;
    border-color: #ffc107;
}

#user-profile-modal .btn-secondary:hover {
